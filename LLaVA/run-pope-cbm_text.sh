...
CUDA_VISIBLE_DEVICES=7 python run-pope-cbm-v1label.py \
        --model-path "liuhaotian/llava-v1.5-7b" --question "indom" --answers-file "$answer_path" --image-folder "$image_folder" --temperature "$temperature"

CUDA_VISIBLE_DEVICES=7 python run-pope-cbm-v1label.py \
        --model-path "liuhaotian/llava-v1.5-7b" --question "outdom" --answers-file "$answer_path" --image-folder "$image_folder" --temperature "$temperature"
