...
def eval_model(args):
    ...
    if args.question=="":
        ...
        # torch.save(output_list, cbm_path+'pope_output_list.pth')  # New code to save model output
        # torch.save(question_list, cbm_path+'pope_question_list.pth')  # New code to save model output
        # torch.save(vit_feature_list, cbm_path+'pope_vit_feature_list.pth')  # New code to save model output
    ...
    #     torch.save(label_list, cbm_path+'vp_pope_label_list_v1.pth')
       ...
       # torch.save(output_list, cbm_path+f'pope_output_list{args.question}.pth')  # New code to save model output
        torch.save(question_list, cbm_path+f'pope_question_list{args.question}.pth')  # New code to save model output
        # torch.save(vit_feature_list, cbm_path+f'pope_vit_feature_list{args.question}.pth')  # New code to save model output
