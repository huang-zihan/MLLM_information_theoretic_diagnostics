...
# # [795, 875, 976, 1074]
# CUDA_VISIBLE_DEVICES=3 python run-aokvqa-cbm-v1.py \
...
# # CUDA_VISIBLE_DEVICES=2 python run-aokvqa-cbm-v1.py \
...
CUDA_VISIBLE_DEVICES=6 python run-aokvqa-cbm-v1.py \
