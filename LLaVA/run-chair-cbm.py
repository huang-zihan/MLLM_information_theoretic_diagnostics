...
def eval_model(args):
    ...
    if args.question=="":
        ...
        # torch.save(output_list, cbm_path+'pope_output_list.pth')  
        # torch.save(question_list, cbm_path+'pope_question_list.pth')  
        # torch.save(vit_feature_list, cbm_path+'pope_vit_feature_list.pth')  
    ...
    #     torch.save(label_list, cbm_path+'vp_pope_label_list_v1.pth')
        ...
        torch.save(label_list, cbm_path+'chair_label_list_v1.pth')
        # torch.save(output_list, cbm_path+f'pope_output_list{args.question}.pth')  
        # torch.save(question_list, cbm_path+f'pope_question_list{args.question}.pth')  
        # torch.save(vit_feature_list, cbm_path+f'pope_vit_feature_list{args.question}.pth') 
