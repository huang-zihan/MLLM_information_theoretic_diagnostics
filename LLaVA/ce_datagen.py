...
ce_data_dir="../cbm/data/"


class MSCOCODataset(Dataset):
    def __init__(self, annotations_file, image_dir, image_processor, model):
...
def eval_model(args):
    ...
    annotations_file = '/home/junda/zihan/cbm/ce_data_full.pth'  
    
    mscoco_dataset = MSCOCODataset(annotations_file, image_dir, image_processor, model)
    ...
    if '_full' in annotations_file:
        torch.save(info_save_list, ce_data_dir+'ce_training_full.pth')
        torch.save(image_info_save_list, ce_data_dir+'ce_training_image_full.pth')
        torch.save(label_list, ce_data_dir+'ce_training_label_full.pth')
    else:
        torch.save(info_save_list, ce_data_dir+'ce_training.pth')
        torch.save(image_info_save_list, ce_data_dir+'ce_training_image.pth')
