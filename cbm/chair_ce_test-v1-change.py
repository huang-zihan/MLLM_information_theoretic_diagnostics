...
input_datas = torch.load(ce_data_dir+'image_chair_info_probe_list_v1.pth')
...
for margin_num in margin_num_list:
    if text_margin:
        ...
        written_file=f'result/image_chair_all_kls_merge_trainepoch{epoch}_v1'
        pic_file=f'result/image_chair_line_chart_merge_trainepoch{epoch}_v1'
        if seperate_layer:
            pic_file=f'result/image_chair_line_chart_seperatelayer_trainepoch{epoch}_v1'
