...
vqa_feature_extract.py
vqa_ms_coco_training_data_trainsform-v1.py # training_set=False

LLaVA/vqa_datagen-v1.py/sh
...
hal_feature_extract.py
hal_ms_coco_training_data_trainsform-v1.py # training_set=False

LLaVA/hal_datagen-v1.py/sh
