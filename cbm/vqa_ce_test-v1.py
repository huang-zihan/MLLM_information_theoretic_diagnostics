...
labels = torch.load(ce_data_dir+f'{prefix}vqa_ce_val_label_full_v1.pth')
print("load from:", ce_data_dir+f'{prefix}vqa_ce_val_label_full_v1.pth')
# else:
# labels = torch.load(ce_data_dir+f'vqa_ce_val_label_full_v1.pth')
input_datas = torch.load(ce_data_dir+f'{prefix}vqa_ce_val_full_v1.pth')
print(ce_data_dir+f'{prefix}vqa_ce_val_full_v1.pth')
...
for text_margin in [True, False]:
    ...
    for margin_num in margin_num_list:
        if text_margin:
            written_file=f'result/{prefix}vqa_all_kls_text_margin_{margin_num}_trainepoch{epoch}_v1'
            pic_file=f'result/{prefix}vqa_line_chart_text_margin_{margin_num}_trainepoch{epoch}_v1'
        else:
            written_file=f'result/{prefix}vqa_all_kls_merge_trainepoch{epoch}_v1'
            pic_file=f'result/{prefix}vqa_line_chart_merge_trainepoch{epoch}_v1'
            if seperate_layer:
                pic_file=f'result/{prefix}vqa_line_chart_seperatelayer_trainepoch{epoch}_v1'
        ...
        if text_margin:
            index_to_cluster=torch.load(f'margin/vqa_index_to_cluster-{margin_num}.pth', weights_only=False)
